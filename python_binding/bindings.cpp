...
PYBIND11_MODULE(minitensor_cpp, m) {
    ...
    py::class_<Tensor<float>>(m_float, "Tensor")
        ...
        .def("vectorized", &to_vector<float>)
        .def("nested", &to_nested<float>)
    ...
    py::class_<Tensor<double>>(m_double, "Tensor")
        ...
        .def("vectorized", &to_vector<double>)
        .def("nested", &to_nested<double>)
    ...
    py::class_<Tensor<int>>(m_int, "Tensor")
        ...
        .def("vectorized", &to_vector<int>)
        .def("nested", &to_nested<int>)
